...
// total orphan, which is the case that actually happened.
{
  ...
  const EXTERNAL_CALLERS: Record<string, string> = {
    ...
    "/api/maintenance": "Daily Vercel cron at 04:43 UTC (vercel.json). CRON_SECRET only; removes expired credentials.",
    ...
    "/api/public-supply/refresh": "Hourly Vercel cron. Fails closed without CRON_SECRET or PUBLIC_SUPPLY_CRON_SECRET.",
