    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6 text-zinc-400 text-sm leading-relaxed">
          ...
          <p><strong className="text-zinc-300">Information you provide:</strong> When you create an account, we collect your email address, username, display name, and password (stored as a secure hash). You may also provide optional profile information such as a bio, location, website, avatar, banner image, accent color, and interest tags.</p>
          <p><strong className="text-zinc-300">Content you create:</strong> Posts, comments, messages, community contributions, and any other content you submit to the platform.</p>
          <p><strong className="text-zinc-300">Connected account data:</strong> When you link third-party platform accounts (such as Instagram, YouTube, TikTok, etc.), we store the platform name, your platform username, and OAuth tokens necessary to access those services on your behalf. We only access data that you explicitly authorize through each platform&apos;s OAuth consent screen.</p>
          <p><strong className="text-zinc-300">Usage data:</strong> We collect information about how you interact with mesh.me, including pages visited, features used, search queries, feed preferences, and interaction patterns. This data helps us improve the Service.</p>
          <p><strong className="text-zinc-300">Device and technical data:</strong> We may collect your IP address, browser type, device type, operating system, and similar technical information for security, analytics, and service optimization purposes.</p>

          <h2 className="text-xl font-semibold text-zinc-200">2. How We Use Your Information</h2>
          <p>We use the information we collect to: (a) provide, operate, and maintain the mesh.me platform; (b) personalize your experience, including your feed, recommendations, and the Mesh visualization; (c) process your transactions (MeshPro subscriptions); (d) send you service-related communications and notifications; (e) generate AI-powered notification summaries (processed locally or through privacy-respecting AI services, never sold to third parties); (f) detect, prevent, and address security issues, fraud, and abuse; (g) comply with legal obligations; (h) improve and develop new features.</p>

          <h2 className="text-xl font-semibold text-zinc-200">3. Information Sharing &amp; Disclosure</h2>
          <p><strong className="text-zinc-300">We do not sell your personal information.</strong> mesh.me has a zero advertising policy and does not share data with advertisers or data brokers.</p>
          <p>We may share your information in the following limited circumstances:</p>
          <p>(a) <strong className="text-zinc-300">Public profile information:</strong> Content you choose to make public (profile, posts, community contributions) is visible to other users and may be indexed by search engines.</p>
          <p>(b) <strong className="text-zinc-300">Connected platforms:</strong> When you perform cross-platform actions (liking, commenting, following) through mesh.me, those actions are executed on the respective third-party platform through your authorized connection. The third-party platform&apos;s privacy policy governs how they handle that data.</p>
          <p>(c) <strong className="text-zinc-300">Service providers:</strong> We may share information with trusted third-party service providers who help us operate the platform (hosting, payment processing, email delivery), subject to strict confidentiality obligations.</p>
          <p>(d) <strong className="text-zinc-300">Legal requirements:</strong> We may disclose information when required by law, legal process, or government request, or when we believe disclosure is necessary to protect our rights, your safety, or the safety of others.</p>

          <h2 className="text-xl font-semibold text-zinc-200">4. Connected Accounts &amp; Third-Party Data</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">5. Data Retention</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">6. Your Privacy Controls &amp; Rights</h2>
          <p>You have the following rights regarding your personal data:</p>
          <p>(a) <strong className="text-zinc-300">Access:</strong> You can view all personal data associated with your account through your profile and settings pages.</p>
          <p>(b) <strong className="text-zinc-300">Correction:</strong> You can update or correct your personal information at any time through your account settings.</p>
          <p>(c) <strong className="text-zinc-300">Deletion:</strong> You can delete your account and all associated data through the settings page. You may also request data deletion by contacting privacy@mesh.me.</p>
          <p>(d) <strong className="text-zinc-300">Data portability:</strong> You can request a copy of your data in a machine-readable format by contacting privacy@mesh.me.</p>
          <p>(e) <strong className="text-zinc-300">Profile visibility:</strong> You can control whether your profile is public or private.</p>
          <p>(f) <strong className="text-zinc-300">Messaging controls:</strong> You can control who can send you messages.</p>
          <p>(g) <strong className="text-zinc-300">Block and mute:</strong> You can block or mute other users at any time.</p>
          <p>(h) <strong className="text-zinc-300">Notification controls:</strong> You can customize which notifications you receive and how they are delivered.</p>
          <p>(i) <strong className="text-zinc-300">Connected account management:</strong> You can connect or disconnect third-party accounts at any time.</p>

          <h2 className="text-xl font-semibold text-zinc-200">7. California Privacy Rights (CCPA)</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">8. European Privacy Rights (GDPR)</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">10. Cookies &amp; Similar Technologies</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">11. Data Security</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">12. AI Features &amp; Data Processing</h2>
          <p>mesh.me uses AI solely for notification summarization to help you manage information overload. AI-processed notification data is not stored beyond the summary generation, is not used to train AI models, and is never shared with or sold to third parties. No other AI features are used on the platform. We do not use AI to generate content, manipulate feeds algorithmically for engagement, or create user profiles for advertising purposes.</p>

          <h2 className="text-xl font-semibold text-zinc-200">13. International Data Transfers</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">14. Changes to This Privacy Policy</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">15. Contact Us</h2>
