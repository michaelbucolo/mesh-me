    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p><strong>Meshi&apos;s journal.</strong> Separately from the read rule above, you can let Meshi keep a small durable journal — only things you explicitly dictate (&ldquo;remember that…&rdquo;), never anything inferred or observed. Every entry is listed in your privacy controls and individually deletable, and turning the journal off deletes every entry immediately and permanently — unlike the read rule, which stops future sending but cannot recall what a provider already received.</p>
