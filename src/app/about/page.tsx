      ...
      <main className="max-w-3xl mx-auto px-6 py-24">
        ...
        <div className="space-y-6 text-zinc-400 text-lg leading-relaxed">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3"><div className="h-1.5 w-1.5 rounded-full bg-blue-500 mt-3 flex-shrink-0" /><span><strong className="text-zinc-200">Identity over vanity metrics.</strong> Your profile should reflect who you are, not how many followers you have.</span></li>
            <li className="flex items-start gap-3"><div className="h-1.5 w-1.5 rounded-full bg-blue-500 mt-3 flex-shrink-0" /><span><strong className="text-zinc-200">Connection over addiction.</strong> We design for meaningful interaction, not infinite scrolling.</span></li>
            <li className="flex items-start gap-3"><div className="h-1.5 w-1.5 rounded-full bg-blue-500 mt-3 flex-shrink-0" /><span><strong className="text-zinc-200">Expression over sameness.</strong> Every profile, every community, every post should feel personal.</span></li>
            <li className="flex items-start gap-3"><div className="h-1.5 w-1.5 rounded-full bg-blue-500 mt-3 flex-shrink-0" /><span><strong className="text-zinc-200">Community over noise.</strong> Quality interactions in smaller spaces beat shouting into the void.</span></li>
            <li className="flex items-start gap-3"><div className="h-1.5 w-1.5 rounded-full bg-blue-500 mt-3 flex-shrink-0" /><span><strong className="text-zinc-200">Safety by default.</strong> Privacy controls, moderation tools, and respectful norms are built in from day one.</span></li>
          </ul>
        </div>
      </main>
    </div>
