    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert prose-zinc max-w-none space-y-6 text-zinc-400 text-sm leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-zinc-200">2. Eligibility</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">3. User Accounts</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">4. User Content</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">5. Prohibited Conduct</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">6. Community Guidelines</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">9. Zero Advertising Policy</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">10. Intellectual Property</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">11. Copyright &amp; DMCA Policy</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">12. Privacy</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">13. Limitation of Liability</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">14. Disclaimer of Warranties</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">15. Indemnification</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">16. Dispute Resolution</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">17. Termination</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">18. Governing Law</h2>
          <p>These Terms shall be governed by and construed in accordance with the laws of the United States, without regard to its conflict of law provisions.</p>

          <h2 className="text-xl font-semibold text-zinc-200">19. Severability</h2>
          <p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law, and the remaining provisions will continue in full force and effect.</p>

          <h2 className="text-xl font-semibold text-zinc-200">20. Changes to Terms</h2>
          ...
          <h2 className="text-xl font-semibold text-zinc-200">21. Contact</h2>
