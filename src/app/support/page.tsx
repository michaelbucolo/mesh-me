        ...
        <div className="rounded-3xl border border-[var(--glass-card-border)] bg-[var(--glass-card-bg)] p-5 shadow-[var(--shadow-sm)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="mt-1 text-3xl font-black leading-tight text-[var(--text-primary)] md:text-5xl">
                Tell us what broke.
              </h1>
            </div>
          </div>
          ...
          <div className="mt-5 grid gap-3">
            <div className="flex gap-3 rounded-2xl border border-[var(--border-primary)] bg-[var(--bg-primary)]/60 p-3">
              ...
              <div>
                <p className="text-sm font-black text-[var(--text-primary)]">Do not send secrets.</p>
            ...
            <div className="flex gap-3 rounded-2xl border border-[var(--border-primary)] bg-[var(--bg-primary)]/60 p-3">
              ...
              <div>
                <p className="text-sm font-black text-[var(--text-primary)]">Send enough context.</p>
                <p className="mt-1 text-sm leading-6 text-[var(--text-secondary)]">
