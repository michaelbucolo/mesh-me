      ...
      <SettingsCard className="overflow-hidden">
        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center">
            <MeshiMascot size={86} mood={meshiFace} hat={meshiHat} color={meshiColor} hair={meshiHair} accessory={meshiAccessory} speaking={false} />
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mt-3 mb-1">Meshi Studio</h2>
            <p className="text-xs text-[var(--text-muted)] max-w-sm">
              Redesign your companion with live preview and one-tap save.
            </p>
          </div>
      ...
      <SettingsCard>
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-[var(--text-muted)] mt-0.5">Show your floating Meshi assistant across Mesh.</p>
          </div>
          <button
            onClick={() => {
      ...
      {meshiEnabled && (
        <>
          ...
          <SettingsCard className="mt-6">
            ...
            <p className="text-xs text-[var(--text-muted)] mb-4">Set your current Meshi build as the app logo across supported surfaces.</p>
