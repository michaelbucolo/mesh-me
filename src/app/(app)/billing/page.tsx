...
export const metadata: Metadata = {
  title: "Billing",
  description: "Manage Mesh Pro billing, subscription status, and Stripe account portal access.",
};
  ...
  return (
    <main className="simple-page grid gap-5">
      <header className="mesh-surface rounded-lg p-4 md:p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          {billing.stripeCustomerId ? (
            ...
            <Button asChild>
              <Link href="/meshpro">Upgrade to Mesh Pro</Link>
            </Button>
          )}
        </div>
      </header>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <BillingStat icon={Crown} label="Plan" value={isPro ? "Mesh Pro" : "Free"} detail={isPro ? "Premium features enabled" : "Core features enabled"} />
      ...
      <section className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_22rem]">
        <div className="mesh-surface rounded-lg p-4 md:p-5">
          ...
          <div className="mt-4 grid gap-3">
            <ControlRow title="Checkout" body="Start a monthly or yearly Mesh Pro subscription from the pricing page." href="/meshpro" label="Open pricing" />
        ...
        <aside className="mesh-surface rounded-lg p-4 md:p-5">
          ...
          <ul className="mt-4 grid gap-3 text-sm leading-6 text-[var(--text-secondary)]">
            ...
            <li>Mesh Pro unlocks optional upgrades; the free app remains useful.</li>
