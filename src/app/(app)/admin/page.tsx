  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          { label: "Total Users", value: stats.userCount, icon: Users, color: "text-indigo-400", bg: "from-indigo-500/10 to-indigo-500/5", sub: `+${stats.recentSignups} this week` },
          { label: "Total Posts", value: stats.postCount, icon: FileText, color: "text-purple-400", bg: "from-purple-500/10 to-purple-500/5", sub: `+${stats.recentPostCount} this week` },
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 p-5">
          ...
          <div className="space-y-2">
            ...
            <div className="w-full h-1.5 bg-zinc-800 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full" style={{ width: `${Math.min(100, (stats.recentSignups / Math.max(stats.userCount, 1)) * 100 * 10)}%` }} />
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="w-full h-1.5 bg-zinc-800 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-purple-500 to-pink-500 rounded-full" style={{ width: `${Math.min(100, (stats.recentPostCount / Math.max(stats.postCount, 1)) * 100 * 10)}%` }} />
            </div>
          </div>
        </div>
              ...
              <div key={u.id} className="flex items-center justify-between py-2.5 px-3 rounded-xl hover:bg-zinc-800/50 transition-colors border-b border-zinc-800/50 last:border-0">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {u.isVerified && <svg className="h-3 w-3 text-indigo-400" viewBox="0 0 24 24" fill="currentColor"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>}
                  </div>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  {u.isAdmin && (
                    <span className="text-[10px] bg-indigo-500/10 text-indigo-400 px-2 py-0.5 rounded-full">Admin</span>
                  )}
