...
export function MeshContextBar({
  ...
  if (viewedUser) {
    ...
    return (
      <div className="mesh-context tray absolute z-30 flex items-center gap-1.5 p-1.5">
        <button
          type="button"
          onClick={onBack}
  ...
  return (
    <div
      className="mesh-context tray absolute z-30 flex items-center gap-1.5 p-1.5"
      role="group"
