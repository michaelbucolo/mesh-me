...
import { setShowPatronChip } from "@/lib/actions";

/**
 * The patron chip's off switch. The record is permanent; wearing it is a
 * choice — same philosophy as the charter chip and activeTitle.
 */
export function PatronChipToggle({ initialShown }: { initialShown: boolean }) {
  ...
  function toggle() {
    ...
    startTransition(async () => {
      const result = await setShowPatronChip(next);
