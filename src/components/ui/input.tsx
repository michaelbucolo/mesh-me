...
const inputClassName =
  "ds-focus-ring flex h-[var(--ds-control-height-lg)] min-w-0 w-full rounded-[var(--ds-radius-md)] border border-[var(--ds-border)] bg-[var(--bg-input)] px-3.5 py-2 text-base sm:text-sm text-[var(--text-primary)] shadow-none transition-[border-color,box-shadow,background-color] duration-150 placeholder:text-[var(--text-muted)] disabled:cursor-not-allowed disabled:opacity-50 aria-[invalid=true]:border-[var(--ds-danger-border)] aria-[invalid=true]:bg-[var(--ds-danger-bg)]";
