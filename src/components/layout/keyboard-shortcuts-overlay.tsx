...
function shortcutKey(value: string) {
  return (
    <kbd
      key={value}
      className="inline-flex min-h-7 min-w-7 items-center justify-center rounded-md border border-[var(--border-primary)] bg-[var(--bg-tertiary)] px-2 text-xs font-black text-[var(--text-primary)] shadow-sm"
    >
      {value}
    </kbd>
  );
  ...
  const content = (
    <>
      <span className="flex min-w-0 flex-col text-left">
        <span className="text-sm font-black text-[var(--text-primary)]">{shortcut.label}</span>
    ...
    <section className="rounded-xl border border-[var(--border-primary)] bg-[var(--bg-secondary)] p-3 sm:p-4">
      <div className="mb-3 flex items-start gap-3">
        ...
        <span className="min-w-0">
          <h3 className="text-sm font-black text-[var(--text-primary)]">{group.title}</h3>
...
export function KeyboardShortcutsOverlay({ username }: { username: string }) {
  ...
  return (
    <>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[var(--border-primary)] bg-[var(--bg-primary)] p-3">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-sm font-black text-[var(--text-primary)]">Press ? anytime outside a text field.</p>
      ...
      <div
        className={cn(
          "pointer-events-none fixed left-1/2 top-4 z-[90] -translate-x-1/2 rounded-full border border-[var(--border-primary)] bg-[var(--bg-primary)]/95 px-3 py-2 text-xs font-black text-[var(--text-primary)] shadow-[var(--shadow-md)] backdrop-blur transition-all",
