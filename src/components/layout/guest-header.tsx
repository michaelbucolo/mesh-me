...
export function GuestHeader() {
  ...
  return (
    <header className="mesh-guest-header public-guest-studio flex shrink-0 flex-wrap items-center justify-between gap-x-4 gap-y-1 border-b border-[var(--border-primary)] bg-[var(--bg-primary)] px-4 pb-2 pt-[max(.75rem,env(safe-area-inset-top))] sm:flex-nowrap sm:px-6">
      <MeshiBrandLockup href="/" size={28} label="mesh.me" className="text-lg" />
