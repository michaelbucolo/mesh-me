...
export function AppChrome({
  ...
  return (
    <>
      ...
      <main className="mobile-app-chrome relative flex-1 overflow-y-auto overflow-x-hidden px-3 pb-32 pt-3 sm:px-4 md:px-5 md:pt-4 lg:px-6 lg:pb-8 lg:pt-5 xl:px-8">
