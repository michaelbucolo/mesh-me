  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} className="rounded-3xl border border-[var(--glass-card-border)] bg-[var(--glass-card-bg)] p-4 shadow-[var(--shadow-sm)] sm:p-5">
      <div className="mb-5 flex items-start gap-3">
        <span className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-[var(--accent)] text-white shadow-[var(--shadow-sm)]">
          <LifeBuoy className="h-5 w-5" aria-hidden="true" />
        </span>
        <div>
          <h2 className="text-xl font-black text-[var(--text-primary)]">Submit a support ticket</h2>
      ...
      <label className="mt-4 grid gap-2 text-sm font-black text-[var(--text-primary)]">
        Category
        <select
          name="category"
      ...
      <div className="mt-4 rounded-2xl border border-dashed border-[var(--border-primary)] bg-[var(--bg-primary)]/60 p-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-sm font-black text-[var(--text-primary)]">Optional screenshot</p>
