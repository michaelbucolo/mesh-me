  ...
  return (
    <>
      ...
      <div className="hidden h-full min-h-0 lg:flex lg:items-center lg:justify-center">
        <div className="mesh-messages-welcome mesh-pop-in mx-auto flex w-full max-w-md flex-col items-center px-8 text-center">
          <SignatureArt />
          <MeshiMascot size={110} mood="happy" prop="envelope" animate showGlow />
          <h2 className="mt-6 text-2xl font-semibold text-[var(--mesh-text)]">Good conversations start here.</h2>
