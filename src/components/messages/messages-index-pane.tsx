    ...
    <>
      ...
      <div className="hidden h-full min-h-0 lg:flex lg:items-center lg:justify-center">
        <div className="mesh-pop-in mx-auto flex w-full max-w-md flex-col items-center px-8 text-center">
          ...
          <h1 className="mt-6 text-2xl font-bold text-[var(--mesh-text)]">Your messages</h1>
          ...
          <Link
            ...
            className="mesh-pressable mt-6 rounded-full bg-[var(--accent)] px-6 py-2.5 text-sm font-bold text-white shadow-[0_4px_20px_var(--accent-glow)] transition hover:brightness-110 active:scale-95"
          >
